...
class KandangPolicy
{
    ...
    {
        return $user->can('view_any_kandang');
    }
    ...
    {
        return $user->can('create_kandang');
    }
    ...
    {
        return $user->can('update_kandang');
    }
    ...
    {
        return $user->can('delete_kandang');
    }
    ...
    {
        return $user->can('delete_any_kandang');
    }
     ...
     */
    public function replicate(User $user, Kandang $kandang): bool
    {
